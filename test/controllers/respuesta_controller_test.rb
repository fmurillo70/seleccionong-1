...
class RespuestaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create respuestum" do
    assert_difference('Respuestum.count') do
      post respuesta_url, params: { respuestum: { puntaje: @respuestum.puntaje, texto: @respuestum.texto } }
    end
  ...
  test "should update respuestum" do
    patch respuestum_url(@respuestum), params: { respuestum: { puntaje: @respuestum.puntaje, texto: @respuestum.texto } }
