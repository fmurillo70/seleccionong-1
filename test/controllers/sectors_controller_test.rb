...
class SectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sector" do
    assert_difference('Sector.count') do
      post sectors_url, params: { sector: { municipio_id: @sector.municipio_id, nombre: @sector.nombre } }
    end
  ...
  test "should update sector" do
    patch sector_url(@sector), params: { sector: { municipio_id: @sector.municipio_id, nombre: @sector.nombre } }
